...
|  2  | [09072026/1634-result.md](09072026/1634-result.md) | Baseline 3D Gaussian Splatting mặc định (Iteration = 15000) - R1 |    **54.97630**     | 19.26 / 53.97 / 31.93 | Baseline mặc định chạy lần 1, điểm số ở mức tốt.                |
|  3  | [09072026/1658-result.md](09072026/1658-result.md) | Baseline 3D Gaussian Splatting mặc định (Iteration = 15000) - R2 |    **52.48840**     | 18.39 / 52.09 / 35.42 | Lượt chạy thứ 2 để test sai số, sụt giảm mạnh ~2.49 điểm.       |
|  4  | [09072026/1713-result.md](09072026/1713-result.md) | Baseline 3D Gaussian Splatting mặc định (Iteration = 15000) - R3 |    **53.41670**     | 18.85 / 53.08 / 34.55 | Lượt chạy thứ 3 để test sai số, nằm ở mức trung bình.           |
|  5  | [09072026/1726-result.md](09072026/1726-result.md) | Baseline 3D Gaussian Splatting mặc định (Iteration = 15000) - R4 |    **53.77280**     | 19.08 / 53.42 / 34.25 | Lượt chạy thứ 4 để test sai số, dao động quanh mức trung bình.  |
|  6  | [09072026/1737-result.md](09072026/1737-result.md) | Baseline 3D Gaussian Splatting mặc định (Iteration = 15000) - R5 |    **53.87740**     | 19.17 / 53.49 / 34.17 | Lượt chạy thứ 5 để test sai số, tương đương Run 4.              |
|  7  | [09072026/2057-result.md](09072026/2057-result.md) | Baseline 3D Gaussian Splatting mặc định (Iteration = 15000) - R6 |    **55.65110**     | 19.49 / 54.86 / 31.25 | Lượt chạy thứ 6 để test sai số, đạt điểm cao nhất của baseline. |
