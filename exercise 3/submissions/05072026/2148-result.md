# Kết quả Benchmark - 21:48 05/07/2026
...
| :-------------- | :----------: | :-------------------------------------------------- |
| `final_score`   |    **15**    | Điểm số cuối cùng                                   |
| `ers`           |    **15**    | Điểm số hiệu năng (Effective Request Score)         |
...
| `tbt_median_ms` |  **59 ms**   | Median Time Between Tokens                          |
| `ttft_p50_ms`   |  **697 ms**  | Time To First Token (P50)                           |
| `ttft_p95_ms`   | **10062 ms** | Time To First Token (P95)                           |
