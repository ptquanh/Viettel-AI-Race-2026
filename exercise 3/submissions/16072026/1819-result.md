...
| :-------------- | :--------: | :---------------------------------------------------- |
| `final_score`   | **43.31**  | Điểm số cuối cùng                                     |
| `ers`           | **43.31**  | Điểm số hiệu năng (Effective Request Score)           |
...
| `ttft_p50_ms`   | **101 ms** | Time To First Token (P50)                             |
| `ttft_p95_ms`   | **146 ms** | Time To First Token (P95)                             |
