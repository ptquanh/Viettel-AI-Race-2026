...
| :-------------- | :--------: | :---------------------------------------------------- |
| `final_score`   | **43.69**  | Điểm số cuối cùng                                     |
| `ers`           | **43.69**  | Điểm số hiệu năng (Effective Request Score)           |
...
| `ttft_p50_ms`   |  **98 ms** | Time To First Token (P50)                             |
| `ttft_p95_ms`   | **143 ms** | Time To First Token (P95)                             |
