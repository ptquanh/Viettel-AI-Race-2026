...
| :-------------- | :--------: | :---------------------------------------------------- |
| `final_score`   | **43.03**  | Điểm số cuối cùng                                     |
| `ers`           | **43.03**  | Điểm số hiệu năng (Effective Request Score)           |
...
| `ttft_p50_ms`   |  **99 ms** | Time To First Token (P50)                             |
| `ttft_p95_ms`   | **155 ms** | Time To First Token (P95)                             |
