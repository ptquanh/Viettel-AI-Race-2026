...
if os.environ.get("VLLM_CUSTOM_KERNEL") == "1":
    print("[Antigravity Phase 2] Injecting Custom Triton Kernel Monkey Patch for LFM2.5...", file=sys.stderr)
    try:
        import vllm
        ...
        print("[Antigravity Phase 2] PagedAttention monkey patched successfully for LFM2.5.", file=sys.stderr)
