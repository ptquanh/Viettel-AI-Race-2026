...
if os.environ.get("VLLM_CUSTOM_KERNEL") == "1":
    print("[Antigravity Phase 2 v3] Injecting Custom Triton Kernel Monkey Patch for LFM2.5...", file=sys.stderr)
    try:
        import vllm
        ...
        print("[Antigravity Phase 2 v3] PagedAttention monkey patched successfully for LFM2.5.", file=sys.stderr)
        
    except Exception as e:
        print(f"[Antigravity Phase 2 v3] Error injecting monkey patch: {e}", file=sys.stderr)
